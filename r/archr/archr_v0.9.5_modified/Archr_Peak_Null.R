...
#
# content:
# addPeak2GeneLinks_save_nullCor()
#
#
# reference:
#
...
#' @export
addPeak2GeneLinks_save_nullCor <- function(
  ArchRProj = NULL,
  ...
  saveRDS(nullCor, "rds/nullCor.rds")
  ...
  colnames(out) <- c("idxATAC", "idxRNA", "Correlation", "Pval","FDR", "VarQATAC", "VarQRNA","EmpPval","EmpFDR")
  mcols(peakSet) <- NULL
  names(peakSet) <- NULL
